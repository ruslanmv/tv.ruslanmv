...
# ---------------------------------------------------------------------------
# Static media: serve generated videos from output/
# ---------------------------------------------------------------------------
# main.py is inside backend/app/main.py  → project root is parents[2]
...
async def health_check():
  ...
  return {
    ...
    "llm_provider": settings.NEWS_LLM_MODEL.split("/")[0]
    if "/" in settings.NEWS_LLM_MODEL
    else "unknown",
  }
