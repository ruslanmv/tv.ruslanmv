...
/**
 * TV.RUSLANMV.COM - Main TV Player Component
 * Retro TV-style interface with auto-play functionality
 */
...
export default function TVPlayer({ episode, autoPlay = true }: TVPlayerProps) {
